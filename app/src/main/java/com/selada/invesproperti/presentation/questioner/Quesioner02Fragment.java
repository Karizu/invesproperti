...
public class Quesioner02Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_quesioner_02, null);
    }
    ...
    private void initComponent() {
        QuesionerData quesionerData = new QuesionerData();
        quesionerData.setData1(data1);
        PreferenceManager.setQuesionerData(quesionerData);
    }
}
